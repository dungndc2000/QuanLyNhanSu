...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, vn.qlns.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, vn.qlns.repository.UserRepository.USERS_BY_EMAIL_CACHE);
